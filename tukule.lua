...
-- Create Main Window
local window = library:AddWindow("Tukule Script", {
...
local farmGymsFolder = mainTab:AddFolder("Enter Gym")
...
local teleportSwitch = rebirthsFolder:AddSwitch("Auto Teleport To King", function(bool)
...
statsFolder:AddButton("Copy Stas To Clipboard", function()
    local player = game.Players.LocalPlayer
...
local timeDropdown = misc3Folder:AddDropdown("Change Time", function(selection)
    ...
    if selection == "Noche" then
        lighting.ClockTime = 0
    elseif selection == "Día" then
        lighting.ClockTime = 12
    elseif selection == "Mediodía" then
...
rebirthFarmFolder:AddLabel("OP Rebirth Farm ")

rebirthFarmFolder:AddTextBox("Target Rebirth (Doesn't work, I Won't make it work)", function(text)
